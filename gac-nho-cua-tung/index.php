...
function isXmlRequest()
{
  ...
  $feedReaders = [
    ...
    'iTMS',
    'itms',
    // Apple Podcasts - via app (international)
    'Podcasts/',
    'Balados/',
    'Podcasti/',
    'Podcastit/',
    ...
    'Podcast/',
    'Podcastok/',
    // Apple Podcasts - Unicode patterns (international)
    'Подкасти/',
    'Подкасты/',
    'פודקסטים/',
    'البودكاست/',
...
if (isXmlRequest()) {
  ...
  <head>
    ...
    <meta name="twitter:description" content="Podcast chia sẻ những câu chuyện, suy ngẫm và trải nghiệm về cuộc sống." />
